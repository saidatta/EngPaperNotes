...
### 4 The VR Protocol Summary {#the-vr-protocol}
...
#### Section 4.3 - Recovery {#41-normal-operation}
...
#### Section 4.4 - Non-deterministic Operations {#44-non-deterministic-operations}
...
#### Section 4.5 - Client Recovery {#45-client-recovery}
...
### Section 5 - Pragmatics {#pragmatics}
...
### Section 6 - Optimizations {#optimizations}
...
Here it introduces a reconfiguration protocol that enables changes to the group of replicas and the failure threshold to adapt to different situations and requirements. The protocol ensures a seamless transition between configurations by transferring the state from the old group to the new group.
...
### Section 8: Correctness of View Changes and Recovery Protocol in VR {#correctness}

Here, provides an informal discussion of the correctness of the protocol. In this section, we'll discuss the correctness of the view change protocol ignoring node recovery and the correctness of the recovery protocol.
...
#### 8.3 Correctness of the Reconfiguration {#83-correctness-of-reconfiguration}
